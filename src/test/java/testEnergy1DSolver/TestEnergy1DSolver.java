...
/**
 * Test the {@link TestEnergy1DSolver} module.
 * 
 * 
 * @author Niccolo' Tubini
 */
public class TestEnergy1DSolver {
...
//		String pathOutputRichards = "resources/Output/Output_Clay_noPonding_hydrostatic_VG_b.nc";
		...
		String pathBottomBCRichards = "C:\\Users\\Niccolo\\Desktop\\EGU2019_notebook\\data\\Timeseries\\0.csv";
		String pathGridRichards =  "C:\\Users\\Niccolo\\Desktop\\EGU2019_notebook\\data\\EGU_Soil_1_Richards.nc"; // Test_Richards.nc";// Test_Richards_noPonding.nc"; //
		String pathOutputRichards = "C:\\Users\\Niccolo\\Desktop\\EGU2019_notebook\\data\\Output_UnTrim_Richards_KNoTemp.nc"; //Output_EGU_Soil_1_Richards_KWithTemp_New1.nc";
		...
		String pathGridEnergy =  "C:\\Users\\Niccolo\\Desktop\\EGU2019_notebook\\data\\EGU_Soil_1_Energy.nc"; //Test_Energy.nc"; // //Test_Energy.nc"; //
		String pathOutputEnergy = "C:\\Users\\Niccolo\\Desktop\\EGU2019_notebook\\data\\Output_UnTrim_Energy_KNoTemp.nc"; //Output_EGU_Soil_1_Energy_KWithTemp_New1.nc";
		...
		CallEnergySolver solver = new CallEnergySolver();
		...
		solver.typeUHCTemperatureModel = "Ronan1998";  // "notemperature"; // 
		...
		solver.richardsBottomBCType = "Bottom Dirichlet";//"Bottom free drainage"; //
