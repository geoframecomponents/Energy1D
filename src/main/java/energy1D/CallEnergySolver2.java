...
import Richards1DSolver.Richards1DSolver2;
...
public class CallEnergySolver2 {
	...
	Energy1DDiffusion diffusionSolver;
	Energy1DAdvection advectionSolver;
	Richards1DSolver2 richardsSolver;
...
//			}
			...
			richardsSolver = new Richards1DSolver2( soilHydraulicModel, typeUHCModel, typeUHCTemperatureModel, richardsTopBCType,
			...
			diffusionSolver = new Energy1DDiffusion( soilHeatCapacityModel, soilThermalConductivityModel, energyTopBCType,
			...
			advectionSolver = new Energy1DAdvection( soilHeatCapacityModel, soilThermalConductivityModel, energyTopBCType,
					energyBottomBCType, interfaceThermalCondType, NUM_CONTROL_VOLUMES, picardIteration,
					tTimestep, deltaZ, spaceDeltaZ, temperatureIC );
...
//		}
		...
		while(sumTimeDelta < tTimestep) {
			...
			diffusionSolver.solve(temperatureTopBC, temperatureBottomBC, richardsTopBC, shortWave, wind, inCurrentDate, timeDelta);
			
//			System.out.println(Variables.thetasOld);
//			System.out.println(Variables.volumes);
//			System.out.println(Variables.temperatures);
...
//			System.out.println(Variables.temperatures);
			...
			advectionSolver.solve(temperatureTopBC, temperatureBottomBC, richardsTopBC, shortWave, wind, inCurrentDate, timeDelta);
		...
		energyOutputToBuffer.add(new double[] {0.0}); //{shortWave}
