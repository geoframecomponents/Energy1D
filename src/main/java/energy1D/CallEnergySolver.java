...
//			}
			...
			richardsSolver = new Richards1DSolver( soilHydraulicModel, typeUHCModel, typeUHCTemperatureModel, richardsTopBCType,
		...
		richardsTopBC = 0.0;
		//richardsTopBC = 3.3333e-04;//(inRichardsTopBC.get(1)[0]/1000)/tTimestep;
		richardsTopBC = 0.0;//(inRichardsTopBC.get(1)[0]/1000)/tTimestep;
